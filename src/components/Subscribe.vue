<template>
  <div class="section md:section-md" id="subscribe">
    ...
    >
      ...
      <div class="content md:content-md" v-html="custom.text.content[0]"></div>

      <div class="email">
        <vue-mailchimp-email-signup-form
  :elementId="'first-email-signup-form'"
  :url="'https://edgeryders.us2.list-manage.com/subscribe/post?u=2426561089e1f5ab32da252cd&amp;id=21ed4ca53d'"
/>
