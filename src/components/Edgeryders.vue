<template>
  <div class="section md:section-md" id="edgeryders">
    ...
    <div class="w-full flex flex-col items-start justify-between">
      <div
        class="w-full flex flex-col md:flex-row md:px-0 md:mt-2 leading-normal"
      >
        <div
          class="w-full pt-0 md:w-1/2 md:px-0 md:pr-8 text-left md:border-r border-gray-200"
        >
          <p class="font-bold text-lg mb-3">Edgeryders is a distributed community of over 5000 people in more than 80 countries who work and collaborate across different projects and organisations online.</p>

          <p class="mb-3">At Edgeryders, working remotely is the default…not the exception. It’s how we were born - Some of the founders had only ever met in person once before setting up a company together!</p>

          <p class="mb-2">7 years later we have built significant experience working with extremely diverse and distributed teams.</p>

          <p class="mb-2">Over time we have collected stories, examples, tips and tricks from our large community, clients and distributed collaboration experts. Whenever time and resources allow for it, we structure and share what we learn with anyone who needs it. Like in our Distributed Collaboration Manual</p>

        </div>
        <div class="md:w-1/2 flex flex-col md:pl-8 mt-4">
          <img :src="getAsset('collaboration.svg')" />
        </div>
      </div>
      <div class="w-full md:flex md:px-0 text-left leading-normal">
        <div class="md:w-1/2 md:pt-8 pr-8 md:border-r border-gray-200 hidden md:inline-block">
        ...
        <div class="md:w-1/2 px-0 pt-4 md:pt-0 mb-12 md:pl-8">
          <h3
